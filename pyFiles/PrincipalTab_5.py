...
space_box3 = widgets.Box(layout=widgets.Layout(width='50%',height = '10px')) # box created to have space among widgets

### Surface Option ###
## generate surface plot column (column 1)
PLOT_label = widgets.HTML('<b>Press Button to Generate Surface Image at a Specific Time:</b>',     
...
time_cont = widgets.HBox([plot_time_label,plot_time]) # plot time limit container

# x and y axis limits for plot column
PltAxis_Label = widgets.Label('Plot Axis limits:',layout = widgets.Layout(width = '45%'))

Xmin_plt = widgets.BoundedIntText(description = 'X Min',min = 0,step = 0.1,
                                  layout = widgets.Layout(width = "50%")) #  x axis min for plot
Xmax_plt = widgets.BoundedIntText(description = 'X Max',step = 0.1,layout = widgets.Layout(width = "50%")) #  x axis max for plot
...
Ymin_plt = widgets.BoundedIntText(description = 'Y Min',max = 20,step = 0.1,
                                  layout = widgets.Layout(width = "50%")) #  y axis min for video
Ymax_plt = widgets.BoundedIntText(description = 'Y Max',max = 20,value = 5,step = 0.1,
...
VIDEO_label = widgets.HTML('<b>Press Button to Generate Model Video:</b>',     
                            layout = widgets.Layout(height = '50px'))
...
TimeLimit_cont = widgets.HBox(children = [TimeLimit_label, TimeLimit_text]) # video time limit container       

# x and y axis limits for video column
VidAxis_Label = widgets.Label('Video Axis limits:',layout = widgets.Layout(width = '45%'))

Xmin_vid = widgets.BoundedIntText(description = 'X Min',min = 0,step = 0.1,
                                  layout = widgets.Layout(width = "50%")) #  x axis min for plot
Xmax_vid = widgets.BoundedIntText(description = 'X Max',step = 0.1,layout = widgets.Layout(width = "50%")) #  x axis max for plot
widgets.jsdlink((Xmin_vid,'value'),(Xmax_vid,'min')) # link Xmin value to Xmax min
Xvid_Cont = widgets.HBox(children = [Xmin_vid, Xmax_vid],
                             layout = widgets.Layout(height = '45px',width = '90%')) # x axis lim container for video
 
Ymin_vid = widgets.BoundedIntText(description = 'Y Min',max = 20,step = 0.1,
                                  layout = widgets.Layout(width = "50%")) #  y axis min for video
Ymax_vid = widgets.BoundedIntText(description = 'Y Max',max = 20,value = 5,step = 0.1,
                                  layout = widgets.Layout(width = "50%")) #  y axis max for video
...
surf_col2 = widgets.VBox(children=[VIDEO_label,TimeLimit_cont,space_box1,VidAxis_Label,Xvid_Cont,Yvid_Cont,space_box1,
                                  Video_button,space_box3,video_load_cont],
                    layout=widgets.Layout(width = '50%'))
...
Surfmean_col2 = widgets.VBox(children=[VIDEO_label,TimeLimit_cont,space_box1,VidAxis_Label,Xvid_Cont,Yvid_Cont,space_box1,
                                       Video_button,space_box3,video_load_cont],
                    layout=widgets.Layout(width = '50%'))
...
u_col2 = widgets.VBox(children=[VIDEO_label,TimeLimit_cont,space_box1,VidAxis_Label,Xvid_Cont,Yvid_Cont,space_box1,
                                Video_button,space_box3,video_load_cont],
                    layout=widgets.Layout(width = '50%'))
...
v_col2 = widgets.VBox(children=[VIDEO_label,TimeLimit_cont,space_box1,VidAxis_Label,Xvid_Cont,Yvid_Cont,space_box1,
                                Video_button,space_box3,video_load_cont],
                    layout=widgets.Layout(width = '50%'))
...
Hmin_col2 = widgets.VBox(children=[VIDEO_label,TimeLimit_cont,space_box1,VidAxis_Label,Xvid_Cont,Yvid_Cont,space_box1,
                                   Video_button,space_box3,video_load_cont],
                    layout=widgets.Layout(width = '50%'))
...
# generate Hsig video column (column 2)
Hmax_col2 = widgets.VBox(children=[VIDEO_label,TimeLimit_cont,space_box1,VidAxis_Label,Xvid_Cont,Yvid_Cont,space_box1,
                                   Video_button,space_box3,video_load_cont],
                    layout=widgets.Layout(width = '50%'))
...
# generate Hsig video column (column 2)
Hsig_col2 = widgets.VBox(children=[VIDEO_label,TimeLimit_cont,space_box1,VidAxis_Label,Xvid_Cont,Yvid_Cont,space_box1,
                                   Video_button,space_box3,video_load_cont],
                    layout=widgets.Layout(width = '50%'))
...
Hrms_col2 = widgets.VBox(children=[VIDEO_label,TimeLimit_cont,space_box1,VidAxis_Label,Xvid_Cont,Yvid_Cont,space_box1,
                                   Video_button,space_box3,video_load_cont],
                    layout=widgets.Layout(width = '50%'))
...
# generate Hrms video column (column 2)
Havg_col2 = widgets.VBox(children=[VIDEO_label,TimeLimit_cont,space_box1,VidAxis_Label,Xvid_Cont,Yvid_Cont,space_box1,
                                   Video_button,space_box3,video_load_cont],
                    layout=widgets.Layout(width = '50%'))
